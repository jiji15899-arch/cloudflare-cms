 ...
 *
 * CSS is embedded inline (Cloudflare Workers have no filesystem —
 * external <link> requests to /cp-admin/css/admin.css would 404
 * unless served by cp-router.js. Inline guarantees styles always load.)
 *
 * @package CloudPress
 */
...
// ---------------------------------------------------------------------------
// Inline CSS (same content as cp-admin/css/admin.css — embedded here so
// the admin UI is always styled even if the CSS route is not hit first)
// ---------------------------------------------------------------------------
